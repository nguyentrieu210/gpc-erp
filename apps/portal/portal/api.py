...
@frappe.whitelist()
def get_my_modules():
    """Trả về các phân hệ (Portal Module) mà user hiện tại được phép truy cập."""
    ...
    return [m for m in modules if is_admin or not m.required_role or m.required_role in roles]
