...
async function initCSRF() {
  try {
    const res = await fetch('/api/method/muahang.api.get_csrf_token')
...
app.component('Button', Button); app.component('Badge', Badge); app.component('FeatherIcon', FeatherIcon)
app.component('LoadingIndicator', LoadingIndicator); app.component('FormControl', FormControl); app.component('ErrorMessage', ErrorMessage)
